      ...
      <div className="w-full max-w-sm bg-white rounded-xl shadow p-8 flex flex-col gap-4">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-purple-600 text-white rounded-lg py-2 font-medium hover:bg-purple-700 transition disabled:opacity-50"
          >
        ...
        <p className="text-xs text-center text-gray-400">
          ...
          <a href="/driver/register" className="text-purple-600 underline">Register</a>
        </p>
      </div>
    </main>
  );
